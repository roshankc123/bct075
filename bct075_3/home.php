...
<body>
      ...
      <div class="profile_display"><h5>'.$u_name.'</h5>
			<div  class="profile_display_btm">
			  ...
			  <div id="profile_border">'.$u_point.'</div> 
				<h4><a href="profile.html">My Profile</a></h4>
		    ...
		    <h3 class="messages">
		      <i class="fa fa-envelope"></i>
			    ...
			    <div class="message_box">
						<h3>New Message</h3>
						<hr>
						<div class="actual_message"> <h4 class="s_image">s_image</h4><h4 class="s_time">s_time</h4>
							<h4 class="s_message">s_message.</h4>	
						</div>
				    </div>   
			</h3>
		  <h3 class="QA">
  ...
  <span class="main">
   ...
   <div id="footer"> Made with \^^/.Copyright @wrc_bct_075</div>
